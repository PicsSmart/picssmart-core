...
const Person = () => {
  ...
  const icon = <BorderColorIcon style={{
    color: 'picsmart.main',
    fontSize: '1.25rem',
  }} />;
  ...
  return (
    <div>
      <Box
        sx={{ width: '100%', height: '150px', display: 'flex', flexDirection: 'row' }}>
        <CardMedia
        ...
        />
        <Box
          sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', marginRight: '50px' }}>
          <Box
